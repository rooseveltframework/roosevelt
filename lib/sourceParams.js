...
let appDir = require('./tools/getAppDir')
let pkg
  ...
  process.argv.forEach(function (val, index, array) {
    switch (val) {
      case 'disable-validator':
        logger.warn('Detected use of "disable-validator" command line argument. This is being deprecated in favor of "-disable-validator".')
      ...
      case 'enable-validator':
        logger.warn('Detected use of "enable-validator" command line argument. This is being deprecated in favor of "-enable-validator"')
