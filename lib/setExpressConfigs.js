...
module.exports = function (app) {
  ...
  const {
    ...
    // todo: research a proper secret - grab something from the randomizer package and do it here in a separate function (lib directory)
    getSecret: () => 'secret',
  ...
  function csrfErrorHandler (error, req, res, next) {
    if (error === invalidCsrfTokenError) {
      logger.warn('You don\'t have permission to access this resource.')
      require(params.errorPages.forbidden)(app, req, res)
    } else {
      next()
    }
  }
