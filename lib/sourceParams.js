...
module.exports = function (app) {
  ...
  params = {
    ...
    sharedTemplateFiles: checkParams(params.sharedTemplateFiles, pkg.rooseveltConfig.sharedTemplateFiles, defaultConfig.sharedTemplateFiles),
  ...
  app.set('sharedTemplateFiles', params.sharedTemplateFiles)
