...
module.exports = function (app) {
  ...
  if (params.js.symlinkToPublic === true) {
    // only enable feature for js if staticsSymlinksToPublic does not include js directories
    if (!params.staticsSymlinksToPublic.includes(params.js.sourceDir) && !params.staticsSymlinksToPublic.includes(params.js.output)) {
      jsSymlink = true
    }
  }

  if (params.css.symlinkToPublic === true) {
    // only enable feature for css if staticsSymlinksToPublic does not include css directories
    if (!params.staticsSymlinksToPublic.includes(params.css.sourceDir) && !params.staticsSymlinksToPublic.includes(params.css.output)) {
      cssSymlink = true
    }
  }
  ...
  if (params.js.compiler === 'none' || params.js.compiler === null) {
    ...
    if (jsSymlink) {
      params.staticsSymlinksToPublic.push(params.js.output)
    }
  }
  ...
  if (params.css.compiler === 'none' || params.css.compiler === null) {
    ...
    if (cssSymlink) {
      params.staticsSymlinksToPublic.push(params.css.output)
    }
  }
