...
module.exports = function (app) {
  ...
  function parseTemplateComment (templateComment, contents, defaultBundle, location) {
    let bundleLocation

    if (templateComment.includes('roosevelt-blacklist')) {
      // If the template is blacklisted, throw an error and skip this
      throw Error(`This item was tried to be exposed in the ${location} method, but included a <!-- roosevelt-blacklist --> tag and will not be exposed`)
