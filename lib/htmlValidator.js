  ...
  process.argv.forEach(function (val, index, array) {
    switch (val) {
      case 'detach-validator':
        logger.warn('Detected use of "detach-validator" command line argument. This is being deprecated in favor of "-detach-validator" and "-dv".')
      ...
      case 'attach-validator':
        logger.warn('Detected use of "attach-validator" command line argument. This is being deprecated in favor of "-attach-validator" and "-av".')
          ...
          new Promise((resolve) => {
            ...
            validator(options, (error, htmlErrorData) => {
              ...
              if (detectErrors) {
                ...
                body = template(fs.readFileSync(path.join(__dirname, '../defaultErrorPages/views/htmlValidator.html')), model)
              }
              resolve(body)
            })
          })
