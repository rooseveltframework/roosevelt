...
module.exports = function (app) {
  ...
  try {
    ...
    if (!params.generateFolderStructure) {
      logger.warn(`Roosevelt initialized in ${appDir} via constructor with no package.json found. No files will be generated unless param generateFolderStructure is set to true. Only do this if you are sure you want files generated in ${appDir}!`.bold.yellow)
