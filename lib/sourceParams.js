...
module.exports = function (app) {
  ...
  if (!fileExists(app.get('appDir') + app.get('params').publicFolder)) {
    // run the param audit
  ...
  params = {
    ...
    nodeEnv: checkParams(params.nodeEnv, pkg.rooseveltConfig.nodeEnv, process.env.NODE_ENV),
    suppressLogs: checkParams(params.suppressLogs, pkg.rooseveltConfig.suppressLogs, defaultConfig.suppressLogs),
