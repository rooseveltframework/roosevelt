...
module.exports = function (app) {
  ...
  if (!params.noMinify) {
    app.use(function (req, res, next) {
      ...
      res.renderMin = (view, renderOpts, callback) => {
        res.render(view, renderOpts, sendMinifiedHTML(callback))
      }
      ...
      if (finalOptions.override && !skip) {
        ...
        res.render = (view, renderOpts, callback) => {
          res.originalRender(view, renderOpts, sendMinifiedHTML(callback))
        }
      }
      next()
    })
