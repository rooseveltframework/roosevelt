...
module.exports = function (app) {
  ...
  params = {
    ...
    clientViewBundles: checkParams(params.clientViewBundles, pkg.rooseveltConfig.clientViewBundles, defaultConfig.clientViewBundles),
  ...
  app.set('clientViewBundles', params.clientViewBundles)
