...
module.exports = function (app, enableCLIFlags) {
  ...
  function checkFlags (flag, opposite) {
    if (!flags[opposite]) {
      ...
      logger.warn(`Detected use of both "${camelCaseToArg(opposite)}" and "${camelCaseToArg(flag)}" command line arguments which are mutually exclusive. Only the first in sequence will be used.`)
    }
  }
