...
module.exports = function (app) {
  ...
  try {
    ...
    logger.error(`${appName} fatal error: could not load controller files from ${app.get('controllersPath')}`.red, e)
  }
  ...
  controllerFiles.forEach(function (controllerName) {
    ...
    if (controllerName !== params.error404) {
      try {
        ...
        logger.error(`${appName} failed to load controller file: ${controllerName}. Please make sure it is coded correctly. See documentation at http://github.com/kethinov/roosevelt for examples.`.red, e)
      }
    }
  })
  ...
  try {
    ...
    logger.error(`${appName} failed to load 404 controller file: ${params.error404}. Please make sure it is coded correctly. See rdocumentation at http://github.com/kethinov/roosevelt for examples.`.red, e)
  }
