...
module.exports = app => {
  ...
  params.errorPages.unauthorized = path.join(app.get('controllersPath'), params.errorPages.unauthorized)
  if (!fsr.fileExists(params.errorPages.unauthorized)) {
    params.errorPages.unauthorized = path.join(__dirname, '../defaultErrorPages/controllers/403')
  }
