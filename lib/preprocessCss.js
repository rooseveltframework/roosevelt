...
module.exports = async app => {
  ...
  if (usingAllowlist) {
    if (typeof params.css.allowlist !== 'object') {
      logger.error(`CSS allowlist not configured correctly. Please ensure that it is an array. See ${docsUrl}/configuration/#staticfileoptions for configuration instructions`)
      return
