...
module.exports = function(app) {
  ...
  params = {
    ...
    keyPath: params.keyPath || pkg.rooseveltConfig.keyPath || {'pfx': 'https/pfx/key.pfx', 'key': 'https/pem/key.pem', 'cert': 'https/pem/cert.pem'},
    passphrase: params.passphrase || pkg.rooseveltConfig.passphrase || '',
