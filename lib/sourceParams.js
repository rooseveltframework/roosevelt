...
module.exports = function(app) {
  ...
  params.staticsRoot = utils.checkParams(params.staticsRoot, pkg.rooseveltConfig.staticsRoot, defaultConfig.staticsRoot);
  ...
  params.publicFolder = utils.checkParams(params.publicFolder, pkg.rooseveltConfig.publicFolder, defaultConfig.publicFolder);
  ...
  params = {
    ...
    suppressLogs: utils.checkParams(params.suppressLogs, pkg.rooseveltConfig.suppressLogs, defaultConfig.suppressLogs),
    ...
    htmlMinify: utils.checkParams(params.htmlMinify, pkg.rooseveltConfig.htmlMinify, defaultConfig.htmlMinify),
  ...
  ['modelsPath', 'viewsPath', 'controllersPath', 'staticsRoot', 'publicFolder', 'cssPath', 'jsPath', 'cssCompiledOutput', 'jsCompiledOutput'].forEach(function(i) {
    var dir = params[i],
        finalChar = dir.charAt(path.length - 1);
  ...
  app.set('suppressLogs', params.suppressLogs);
