...
module.exports = app => {
  ...
  if (params.csrfProtection && params.makeBuildArtifacts !== 'staticsOnly') {
    ...
    // TODO: should do it this way instead?
    /*
    function getTokenFromSession (req) {
      // console.log(req.session.csrfToken) // TODO: this is undefined
      return req.session && req.session.csrfToken // or whatever key you use
    }
    ...
    const {
      ...
      getTokenFromState: getTokenFromSession
    })
    */
