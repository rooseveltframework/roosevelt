...
```
_Note: if your Roosevelt app was created with an older version, you may not have this command in your npm scripts. If so, then manually add this npm script to your package.json: "kill-validator": "node ./node_modules/roosevelt/lib/killValidator.js"_
...
npm run cleanup
```
_Note: if your Roosevelt app was created with an older version, you may not have this command in your npm scripts. If so, then manually add this npm script to your package.json: "cleanup": "node ./node_modules/roosevelt/lib/appCleanup.js"_
...
npm run audit
```
_Note: if your Roosevelt app was created with an older version, you may not have this command in your npm scripts. If so, then manually add this npm script to your package.json: "audit": "node ./node_modules/roosevelt/lib/configAuditor.js"_
