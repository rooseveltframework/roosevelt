...
module.exports = function(app) {
  ...
  params = {
    ...
    bodyParserOptions: params.bodyParserOptions || pkg.rooseveltConfig.bodyParserOptions || { extended: true },
    bodyParserJsonOptions: params.bodyParserJsonOptions || pkg.rooseveltConfig.bodyParserJsonOptions || {},
    // mvc
    ...
    htmlMinify: params.htmlMinify || pkg.rooseveltConfig.htmlMinify || {override: true, exception_url: false, htmlMinifier: {html5: true}},
