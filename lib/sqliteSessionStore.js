/*
  This is a hard fork of better-sqlite3-session-store:
  https://github.com/attestate/better-sqlite3-session-store

  It includes the changes from this PR:
  https://github.com/attestate/better-sqlite3-session-store/pull/12
*/
