...
module.exports = function(app) {
  ...
  params = {
    ...
    keyPath: params.keyPath || pkg.rooseveltConfig.keyPath, // object with pfx / key+cert (file paths)
    passphrase: params.passphrase || pkg.rooseveltConfig.passphrase, // string
    ca: params.ca || pkg.rooseveltConfig.ca, // string or array of strings (file paths). if used, server will request authorization & reject unauthorized users
