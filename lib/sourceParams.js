...
module.exports = function (app) {
  ...
  const schema = {
    ...
    clientViews: {
      ...
      output: {
        default: checkParam('output', ['clientViews'])
      },
      exposeAll: {
        default: checkParam('exposeAll', ['clientViews'])
      },
      defaultBundle: {
        default: checkParam('defaultBundle', ['clientViews'])
      },
      minify: {
        default: checkParam('minify', ['clientViews'])
      },
      minifyOptions: {
