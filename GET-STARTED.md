...
- `roosevelt.config.js`: Where your Roosevelt config is stored and what your params are set to. It is a JavaScript file, so it can hold comments and code as well as plain values. These values can be overridden when calling Roosevelt's constructor.
