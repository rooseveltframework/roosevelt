...
module.exports = function (app) {
  ...
  params = {
    ...
    frontendReload: checkParams(params.frontendReload, pkg.rooseveltConfig.frontendReload, defaultConfig.frontendReload),
    ...
    routers: checkParams(params.routers, pkg.rooseveltConfig.routers, defaultConfig.routers),
    ...
    // preprocessors
    jsCompiler: params.jsCompiler || undefined,
    cssCompiler: params.cssCompiler || undefined
  }
