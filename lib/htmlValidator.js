    ...
    promise = (() => {
      return new Promise((resolve, reject) => {
        ...
        validatorProcess.on('error', (err) => {
          if (err.code === 'ENOENT' ) {
            console.error('error: You must install Java to continue. Warning: HTML validation disabled, error on initialization (check to make sure Java is installed and in your path)');
          }
          else {
