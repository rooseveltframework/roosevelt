...
module.exports = function (app, callback) {
  ...
  function applyValidatorMiddleware () {
    ...
    app.use('/scripts', express.static(path.join(appDir, '/node_modules/prismjs/')))
          ...
          new Promise((resolve) => {
            ...
            validator(options, (error, htmlErrorData) => {
              ...
              for (i in markupArray) {
                ...
                formattedHTML += Prism.highlight(`${markupLine}\n`, Prism.languages.markup) // 1. - highlight no format
                formattedHTML += `</span>`
              }
              formattedHTML += `</code>\n</pre>`
